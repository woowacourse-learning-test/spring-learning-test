...
- 테스트 메서드: `cholog.ExceptionTest.checkPriorityOfHandlingException`
- 수행 방법
    - `cholog.controller.ReservationController` 과 `cholog.controller.GlobalExceptionHandler` 중 하나의 `DuplicatedException`
      에 대한 핸들러 메서드를 삭제해 테스트를 성공시키세요.
      <br>
